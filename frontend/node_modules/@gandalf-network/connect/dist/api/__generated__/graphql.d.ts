...
export type GetAppByPublicKeyQuery = {
    __typename?: 'Query';
    getAppByPublicKey: {
        __typename?: 'Application';
        appName: string;
...
export type GetSupportedServicesQueryVariables = Exact<{
    [key: string]: never;
}>;
export type GetSupportedServicesQuery = {
    __typename?: 'Query';
    __type?: {
        __typename?: '__Type';
        name?: string | null;
...
export declare const GetAppByPublicKeyDocument: DocumentNode<GetAppByPublicKeyQuery, Exact<{
    publicKey: Scalars['String']['input'];
}>>;
export declare const GetSupportedServicesDocument: DocumentNode<GetSupportedServicesQuery, Exact<{
    [key: string]: never;
}>>;
